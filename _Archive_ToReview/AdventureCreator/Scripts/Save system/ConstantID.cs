...
namespace AC
{
	...
	*/
	...
	public class ConstantID : MonoBehaviour
	{
		 ...
		 * <param name = "constantID">The Constant ID number generated by the ConstantID component</param>
		 * <param name = "root">If provided, only components on this or children of this object will be searched</param> 
		 * <returns>The component with a matching Constant ID number</returns>
		 */
		public static T GetComponent <T> (int constantIDValue, GameObject root = null) where T : Component
		{
			...
			if (!Application.isPlaying || KickStarter.stateHandler == null)
			{
				...
				if (root)
				{
					objects = root.GetComponentsInChildren<T> ();
				}
				else
				{
					objects = UnityVersionHandler.FindObjectsOfType <T>();
				}
		...
		private ConstantID[] GetAllIDScriptsInHierarchy ()
		{
			...
			{
				idScripts = UnityVersionHandler.FindObjectsOfType<ConstantID> ();
			}
			return idScripts;
		}
		...
		{
			SetParametersBase[] setParametersBases = UnityVersionHandler.FindObjectsOfType <SetParametersBase>();
