...
namespace AC
{
	...
	public class EventManager : MonoBehaviour
	{
		...
		/** A delegate for the OnEventFire event */
		public delegate void Delegate_OnEventFire(EventBase eventBase);
		/** An event triggered when an event is fired from the Event Runner or Events Editor */
		public static event Delegate_OnEventFire OnEventFire;

		/** Triggers the OnEventFire event */
		public void Call_OnEventFire(EventBase eventBase)
		{
			if (OnEventFire != null)
			{
				OnEventFire(eventBase);
			}
		}
