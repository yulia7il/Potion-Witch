...
namespace AC
{
	...
	public class NGWData : ScriptableObject
	{
		...
		[NonSerialized] public InterfaceOption interfaceOption = InterfaceOption.AdventureCreator;
		public enum InterfaceOption { None, AdventureCreator, UnityUI }

		[NonSerialized] public CameraPerspective cameraPerspective;
		[NonSerialized] public MovementMethod movementMethod;
		[NonSerialized] public InputMethod inputMethod;
		[NonSerialized] public AC_InteractionMethod interactionMethod;
		[NonSerialized] public HotspotDetection hotspotDetection;
