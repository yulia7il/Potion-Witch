...
namespace AC
{
	...
	public class DefaultInterface
	{
		...
		{	
			...
			if (profilesMenu)
			{
				...
				if (deleteElement && deleteElement is MenuButton)
				{
					...
					EditorUtility.SetDirty (deleteElement);
				}
				EditorUtility.SetDirty (profilesMenu);
			}
			...
			if (craftingMenu)
			{
				...
				if (createElement && createElement is MenuButton)
				{
					...
					EditorUtility.SetDirty (createButton);
				}
				EditorUtility.SetDirty (craftingMenu);
			}
			...
			if (objectivesMenu)
			{
				...
				if (objectivesElement && objectivesElement is MenuInventoryBox)
				{
					...
					EditorUtility.SetDirty (objectivesList);
				}
				EditorUtility.SetDirty (objectivesMenu);
			}
		...
		private static ActionListAsset CreateActionList_PauseGame (string installPath)
		{
			...
			ActionListAsset newAsset = ActionListAsset.CreateFromActions ("ActiveInput_PauseGame", installPath, actions, ActionListType.RunInBackground);
			return newAsset;
		}
		...
		private static ActionListAsset CreateActionList_CloseCrafting (string installPath)
		{
			...
			ActionListAsset newAsset = ActionListAsset.CreateFromActions ("ClearRecipe", installPath, actions, ActionListType.RunInBackground);
			return newAsset;
		}
		...
		private static ActionListAsset CreateActionList_CreateNewProfile (string installPath)
		{
			...
			ActionListAsset newAsset = ActionListAsset.CreateFromActions ("CreateNewProfile", installPath, actions, ActionListType.RunInBackground);
			return newAsset;
		}
		...
		private static ActionListAsset CreateActionList_DeleteActiveProfile (string installPath)
		{
			...
			ActionListAsset newAsset = ActionListAsset.CreateFromActions ("DeleteActiveProfile", installPath, actions, ActionListType.RunInBackground);
			return newAsset;
		}
		...
		private static ActionListAsset CreateActionList_SetupPauseMenu (string installPath)
		{
			...
			ActionListAsset newAsset = ActionListAsset.CreateFromActions ("SetupPauseMenu", installPath, actions, ActionListType.RunInBackground);
			return newAsset;
		}
		...
		private static ActionListAsset CreateActionList_DoCrafting (string installPath)
		{
			...
			ActionListAsset newAsset = ActionListAsset.CreateFromActions ("CreateRecipe", installPath, actions, ActionListType.RunInBackground);
			return newAsset;
		}
		...
		private static ActionListAsset CreateActionList_HideSelectedObjective (string installPath)
		{
			...
			ActionListAsset newAsset = ActionListAsset.CreateFromActions ("HideSelectedObjective", installPath, actions, ActionListType.RunInBackground);
			return newAsset;
		}
		...
		private static ActionListAsset CreateActionList_QuitButton (string installPath)
		{
			...
			ActionListAsset newAsset = ActionListAsset.CreateFromActions ("QuitButton", installPath, actions, ActionListType.RunInBackground);
			return newAsset;
		}
		...
		private static ActionListAsset CreateActionList_SetupProfilesMenu (string installPath)
		{
			...
			ActionListAsset newAsset = ActionListAsset.CreateFromActions ("SetupProfilesMenu", installPath, actions, ActionListType.RunInBackground);
			return newAsset;
		}
		...
		private static ActionListAsset CreateActionList_ShowSelectedObjective (string installPath)
		{
			...
			ActionListAsset newAsset = ActionListAsset.CreateFromActions ("ShowSelectedObjective", installPath, actions, ActionListType.RunInBackground);
			return newAsset;
		}
		...
		private static ActionListAsset CreateActionList_TakeAllContainerItems (string installPath)
		{
			...
			ActionListAsset newAsset = ActionListAsset.CreateFromActions ("TakeAllContainerItems", installPath, actions, ActionListType.RunInBackground);
			return newAsset;
		}
