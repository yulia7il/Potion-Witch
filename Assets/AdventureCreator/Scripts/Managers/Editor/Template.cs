...
namespace AC
{
	...
	public abstract class Template : ScriptableObject
	{
		...
		public virtual void AmendData (NGWData data) { }
		...
		protected void InstallActionsFolder (UnityEngine.Object folderObj)
		{
			...
			{
				if (KickStarter.actionsManager.customFolderPaths.Count == 0)
				{
					KickStarter.actionsManager.customFolderPaths.Add (string.Empty);
				}
