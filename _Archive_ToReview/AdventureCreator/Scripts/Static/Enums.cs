...
namespace AC
{
	...
	public enum SetParamMethod { EnteredHere=0, Random=2, CopiedFromGlobalVariable=1, CopiedFromLocalVariable=6, CopiedFromComponentVariable=5, CopiedFromParameter=3, CopiedFromAnimator=4, Formula=5 };
	...
	public enum StringCondition { EqualTo, NotEqualTo, Contains };
	...
	public enum ObjectiveSorting { ByStartTime, ByUpdateTime, ByID, ByEditorIndex };
